...
#тест частично отключен, т.к. после смены почтового сервера не могу сделать удаление писем, возможно потом вернусь.
#если его полностью отключить то индикация в дженкинсе будет желтая
def test_mail_iss():
    wd = webdriver.Chrome()
